...
if(isChromeContext){FBL.Env=window.Firebug.SharedEnv;
...
if(!FBL.Env.isDevelopmentMode){window.Firebug.SharedEnv.destroy();
...
}else{this.addEvent(e,"mousedown",disableTextSelectionHandler)
...
}else{this.removeEvent(e,"mousedown",disableTextSelectionHandler)
}};
...
var parentPanelMap={};
var reps=[];
window.Firebug=FBL.Firebug={version:"Firebug Lite 1.3.0a3",revision:"$Revision: 5272 $",modules:modules,panelTypes:panelTypes,reps:reps,initialize:function(){if(FBTrace.DBG_INITIALIZE){FBTrace.sysout("Firebug.initialize","initializing application")
...
},shutdown:function(){dispatch(modules,"shutdown",[]);
...
append(ChromeBase,{create:function(){Firebug.PanelBar.create.apply(this);
if(Firebug.Inspector){this.inspectButton=new Firebug.Button({type:"toggle",node:$("fbChrome_btInspect"),owner:Firebug.Inspector,onPress:Firebug.Inspector.startInspecting,onUnpress:Firebug.Inspector.stopInspecting})
...
}if(isIE&&Firebug.Selector){var as=$$(".fbHover");
for(var i=0,a;
a=as[i];
...
this.close()
}},destroy:function(){ChromeBase.destroy.call(this);
...
this.addController([Firebug.browser.window,"resize",this.resize],[Firebug.browser.window,"unload",Firebug.shutdown],[$("fbChrome_btClose"),"click",this.close],[$("fbChrome_btDetach"),"click",this.detach]);
