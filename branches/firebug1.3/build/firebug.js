...
if(isIE){addEvent(Application.browser.document.documentElement,"mouseleave",onHSplitterMouseUp)
...
if(isIE){removeEvent(Application.browser.document.documentElement,"mouseleave",onHSplitterMouseUp)
