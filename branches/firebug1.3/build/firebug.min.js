...
this.Application={openAtStartup:false,isBookmarletMode:true,isPersistentMode:false,isTraceMode:false,skin:"xp",isDevelopmentMode:false,isChromeContext:false,browser:null,chrome:null};
...
this.messageQueue=[];
this.module=null;
this.initialize=function(){for(var name in traceOptions){this[name]=traceOptions[name]
}};
...
var panelTypes=[];
var panelTypeMap={};
Application.browser.window.Firebug=FBL.Firebug={version:"Firebug Lite 1.3.0a2",revision:"$Revision: 3847 $",modules:modules,panelTypes:panelTypes,initialize:function(){if(FBTrace.DBG_INITIALIZE){FBTrace.sysout("Firebug.initialize","initializing application")
