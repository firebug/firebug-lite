...
var panelTypes=[];
var panelTypeMap={};
Application.browser.window.Firebug=FBL.Firebug={version:"Firebug Lite 1.3.0a2",revision:"$Revision: 3846 $",modules:modules,panelTypes:panelTypes,initialize:function(){if(FBTrace.DBG_INITIALIZE){FBTrace.sysout("Firebug.initialize","initializing application")
