...
var panelTypes=[];
var panelTypeMap={};
FBL.Firebug={version:"Firebug Lite 1.3.0a2",revision:"$Revision: 3806 $",modules:modules,panelTypes:panelTypes,chromeMap:{},initializeContext:function(chrome){},initialize:function(){if(FBTrace.DBG_INITIALIZE){FBTrace.sysout("Firebug.initialize","initializing application")
...
var tabNode=this.tabNode=createElement("a",{id:panelId+"Tab",className:"fbTab"+(isIE?" fbHover":""),innerHTML:tabHTML});
