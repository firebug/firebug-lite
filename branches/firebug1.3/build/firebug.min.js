...
FBL.ns(function(){with(FBL){FBL.FirebugChrome={commandLineVisible:true,sidePanelVisible:false,sidePanelWidth:300,selectedPanel:"Console",height:250,isOpen:true,create:function(){createChrome({onLoad:onChromeLoad})
...
}},showBoxModel:function(){if(!boxModelVisible){document.body.appendChild(boxModel);
