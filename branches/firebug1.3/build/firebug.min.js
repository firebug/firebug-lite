...
var panelTypes=[];
var panelTypeMap={};
FBL.Firebug={version:"Firebug Lite 1.3.0a2",revision:"$Revision: 3802 $",modules:modules,panelTypes:panelTypes,chromeMap:{},initializeContext:function(chrome){},initialize:function(){if(FBTrace.DBG_INITIALIZE){FBTrace.sysout("Firebug.initialize","initializing application")
