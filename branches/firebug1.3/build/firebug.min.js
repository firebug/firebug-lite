...
this.Application={openAtStartup:true,isBookmarletMode:true,isPersistentMode:false,isTraceMode:true,skin:"xp",isDevelopmentMode:false,isChromeContext:false,browser:null,chrome:null};
...
var panelTypes=[];
var panelTypeMap={};
FBL.Firebug={version:"Firebug Lite 1.3.0a2",revision:"$Revision: 3837 $",modules:modules,panelTypes:panelTypes,chromeMap:{},initializeContext:function(chrome){},initialize:function(){if(FBTrace.DBG_INITIALIZE){FBTrace.sysout("Firebug.initialize","initializing application")
